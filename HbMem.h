...
#define HbMem_Tag_Alloc(tag, type, count) ((type *) HbMem_Tag_AllocElements((tag), sizeof(type), (count), HbTrue, __func__, __LINE__))
#define HbMem_Tag_AllocChecked(tag, type, count) ((type *) HbMem_Tag_AllocElements((tag), sizeof(type), (count), HbFalse, __func__, __LINE__))
...
#define HbMem_Tag_Realloc(buffer, type, count) HbMem_Tag_ReallocElements((void * *) &(buffer), sizeof(type) * (count), HbTrue)
#define HbMem_Tag_ReallocChecked(buffer, type, count) HbMem_Tag_ReallocElements((void * *) &(buffer), sizeof(type) * (count), HbFalse)
